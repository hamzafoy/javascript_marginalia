...
globalModifierTest.test(exampleString) ? console.log(`This RegExp has found ${globalModifierCounter} match(es)`) : console.log(`This RegExp has found no matches.`); //EXPECTED OUTPUT: `This RegExp found a match.`
caseInsensitiveModifierTest.test(exampleString) ? console.log(`This RegExp has found ${caseInsensitiveCounter} match(es)`) : console.log(`This RegExp has found no matches.`); //EXPECTED OUTPUT: `This RegExp found a match.`
